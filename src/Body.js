...
const Body =() =>
{
    const restodata =[

        {
            ...
            "thirdPartyVendor": "",
            "adTrackingID": "cid=5765967~p=19~eid=00000185-cec8-02a6-059f-026900161347",
            "badges": {
            "imageBased": [],
            "textBased": [],
            "textExtendedBadges": []
...

        {
            ...
            "cityState": "1",
            "address": "McDonald's Family Restaurant, ND Fusion Mall, Site no 73 / 74/ 113 / 114, BTM 2nd Stage, Ist phase, Landmark - Behind Udupi Garden",
            "locality": "2nd Stage",
            "parentId": 630,
            "unserviceable": false,
            "veg": false,
    ...
    return (<div className="resturant-card">
            {
                ...
                {
                    return  <ResturantCard key={restaurant.data.uuid}
                    { ...restaurant.data } />
